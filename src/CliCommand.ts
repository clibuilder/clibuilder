...
export interface CliCommandInstance<Config = any, Context = { [k in string]: any }> extends CliCommand.Base, CliCommand.Shared {
  cwd: string
...
export interface CliCommand<Config = any, Context = { [k in string]: any }> extends CliCommand.Shared {
  commands?: CliCommand[],
  run?: (this: CliCommandInstance & Context & { config?: Config }, args: CliArgs, argv: string[]) => void | Promise<any>
}
